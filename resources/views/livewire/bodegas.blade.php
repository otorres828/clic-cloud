<div>
    <h1 class="font-semibold text-gray-700 text-ellipsis text-center pt-2">Listado de Bodegas</h1>
    <div class="rounded-lg border border-gray-200 shadow-md m-5 ">
        <div class="flex justify-around">
            ...
            <input type="text" wire:model="buscar"
                ...
                placeholder="Escribe algo relacionado a la bodega">
                    ...
                    @foreach ($bodegas as $bodega)
                        <tr class="hover:bg-gray-50">
                            <th class="flex gap-3 px-6 py-4 font-normal text-gray-900">
                                ...
                                <div class="text-sm">
                                    <div class="text-gray-400">{{ $bodega->id }}</div>
                                </div>
                            </th>
            ...
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full"
                    ...
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-headline">
                                {{ !$this->bodega_id ? 'Crear Bodega' : 'Actializar Bodega' }}
                            </h3>
                            <div class="mt-2">
                                <form>
                                    <div class="mb-4">
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <button wire:click="store" type="button"
                        ...
                        {{$this->bodega_id ? 'Actualizar' : 'Crear'}}
                    </button>
